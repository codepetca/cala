...
export const ChipCard = forwardRef<HTMLDivElement, ChipCardProps>(
  ({ event, isDragging = false, isOverflow = false, onEdit, onClick, className = '', style, ...props }, ref) => {
...
export function SortableChipCard({ dragData, onClick, ...props }: SortableChipCardProps) {
